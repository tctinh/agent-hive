# Task: 04-delete-contextread-and-contextlist-tools
...
- 03-rename-sessionopen-to-hivestatus-delete-sessionservice: ## Renamed session_open to hive_status, Deleted SessionService
