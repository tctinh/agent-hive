...
- 04-drop-hiveask: Dropped hive_ask tool and all related code. Removed: ask.ts (129 lines), panels/ (1117 lines), webview/ (341 lines). Cleaned extension.ts (statusBarItem, AskService, hive.showAsk/openQueenPanel commands). Updated hive-core/services/index.ts. Updated opencode-hive docs. Net -1,706 lines.
- 05-consolidate-skills--hivemd: Consolidated 3 skills (hive-workflow, hive-planning, hive-execution) into single hive.md. Removed 548 lines net. Updated templates.ts, opencode-hive/index.ts, and initNest.ts to use unified 'hive' skill.
