...
| **Honey** | Artifacts | The human-facing sweetness of the work — led by `context/overview.md`, with `plan.md`, `spec.md`, `report.md`, and code behind it. |
...
Planning is collaborative. Execution is autonomous. Humans should usually review `context/overview.md` first for the narrative, then inspect `plan.md` for the execution contract. The approval gate is where trust is earned.
