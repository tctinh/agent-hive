...
type SidebarItem = ActionItem | StatusGroupItem | FeatureItem | PlanItem | ContextFolderItem | ContextFileItem | TasksGroupItem | TaskItem | TaskFileItem | CopilotArtifactsGroupItem | ArtifactCategoryItem | ArtifactFileItem
